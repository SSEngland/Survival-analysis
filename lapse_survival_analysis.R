#this script is the real survival analysis, github site https://github.com/jzj59/lapse-prediction/blob/master/Lapse_Prediction/lapse_survival_functions.R
#it also has a shiny app which I haven't downloaded
